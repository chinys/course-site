    ...
    lessons = [
        (
            ...
            <div class="mt-6 p-5 bg-gray-50 border border-gray-300 rounded-xl shadow-sm">
                ...
                <ul class="list-disc pl-5 space-y-2 text-sm text-gray-700">
                    ...
                    <li><strong class="text-gray-900">불법 재하도급 및 명의대여 판별:</strong> 대법원 2003. 5. 13. 선고 <a href="https://www.law.go.kr/precSc.do?menuId=7&subMenuId=47&tabMenuId=213&query=2002%EB%8F%847425" class="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">2002도7425 판결</a> (국가법령정보센터 | 실질적 시공 관여 여부에 의한 무등록 재하도급 및 명의대여 판단 기준)</li>
                    <li><strong class="text-gray-900">일괄하도급 및 위반죄의 성립:</strong> 대법원 2016. 4. 12. 선고 <a href="https://www.law.go.kr/precSc.do?menuId=7&subMenuId=47&tabMenuId=213&query=2015%EB%8F%8411634" class="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">2015도11634 판결</a> (국가법령정보센터 | 건설공사 일괄 하도급 금지 위반 및 무등록 업체 하도급의 법적 판단)</li>
        ...
        (
            ...
            <div class="mt-6 p-5 bg-gray-50 border border-gray-300 rounded-xl shadow-sm">
                <h4 class="font-bold text-gray-900 mb-3 border-b border-gray-300 pb-2 flex items-center gap-2"><span>📚</span> 참조 출처 및 관련 판례/행정해석</h4>
                <ul class="list-disc pl-5 space-y-2 text-sm text-gray-700">
                    <li><strong class="text-gray-900">제작물공급과 건산법 적용 분별 기준:</strong> 대법원 2010. 11. 25. 선고 <a href="https://www.law.go.kr/precSc.do?menuId=7&subMenuId=47&tabMenuId=213&query=2010%EB%8B%A456685" class="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">2010다56685 판결</a> (국가법령정보센터 | 부대체물의 제작·공급 시 도급의 성질 인정 및 건설 관련 법규 적용 기준)</li>
                    <li><strong class="text-gray-900">설치 시공이 포함된 물품공급의 실질:</strong> 대법원 1996. 6. 28. 선고 <a href="https://www.law.go.kr/precSc.do?menuId=7&subMenuId=47&tabMenuId=213&query=94%EB%8B%A442976" class="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">94다42976 판결</a> (국가법령정보센터 | 주문 제작물의 공급 및 현장 설치 행위의 법적 성격 판별)</li>
