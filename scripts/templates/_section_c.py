...
<h3 class="text-xl font-bold text-gray-800 mb-2 flex items-center"><span class="bg-purple-100 text-purple-800 text-sm py-1 px-3 rounded-full mr-3">C-1</span> 기술&middot;품질용역 위탁계약서(비파괴검사 NDT)</h3>
...
<div class="bg-purple-50 p-5 rounded text-sm text-purple-900 border border-purple-200 flex gap-3 mt-4"><span class="text-2xl flex-shrink-0 mt-1">💡</span>

<div><strong class="text-base block mb-1">매뉴얼 지침:</strong> NDT는 건설 시공이 아닌 <strong>품질검사 엔지니어링 용역</strong>이므로 건산법 하도급 규제와 무관합니다. 세금계산서 품목은 반드시 <strong>"철골 용접부 비파괴검사(NDT) 기술용역비"</strong>로 기재하십시오.
...
<h3 class="text-xl font-bold text-gray-800 mb-2 flex items-center"><span class="bg-purple-100 text-purple-800 text-sm py-1 px-3 rounded-full mr-3">C-2</span> 건설현장 급식(함바식당) 운영 위탁계약서</h3>
...
<div><strong class="text-base block mb-1">매뉴얼 지침:</strong> 함바식당 운영은 건설공사가 아닌 <strong>식품접객업(집단급식)</strong>이므로 건산법 하도급 규제와는 무관합니다. 그러나 현장 안에서 운영되므로 <strong>①식품배상책임보험(PL보험) 가입 확인 ②보건증 전원 소지 확인 ③세금계산서 품목을 반드시 "급식 위탁 운영비"로 기재</strong>하는 것이 핵심입니다. 만약 세금계산서 품목에 "현장 노무비"나 "인력 지원비" 등으로 잘못 끊으면, 수사 시 인력 파견 또는 하도급으로 오인받을 소지가 있으니 주의하십시오.
