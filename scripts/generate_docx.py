...
def generate_all():
    ...
    contracts = [
        ('A1', '물품공급 및 가공제작 계약서 (A-1)', sa, '<!-- A-1', '<!-- A-2'),
        ('A2', '외주 사급가공 계약서 (A-2)', sa, '<!-- A-2', '<!-- A-3'),
        ('A3', '사내가공제작(사내도장) 계약서 (A-3)', sa, '<!-- A-3', None),
        ('B1', '건설기계 장비 임대차(사용) 계약서 (B-1)', sb, '<!-- B-1', '<!-- B-2'),
        ('B2', '가설재(비계·서포트) 임대차계약서 (B-2)', sb, '<!-- B-2', None),
        ('C1', '비파괴검사(NDT) 기술·품질용역 위탁계약서 (C-1)', sc, '<!-- C-1', '<!-- C-2'),
